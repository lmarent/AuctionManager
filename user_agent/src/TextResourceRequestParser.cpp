...
/*!  \file   TextResourceRequestParser.cpp
    ...
    $Id: TextResourceRequestParser.cpp 2015-08-26 08:10:00 amarentes $
*/
...
TextResourceRequestParser::TextResourceRequestParser(string filename)
    : fileName(filename)
{
    log = Logger::getInstance();
    ch = log->createChannel("TextResourceRequestParser" );
}


TextResourceRequestParser::TextResourceRequestParser(char *b, int l)
    : buf(b), len(l)
{
    log = Logger::getInstance();
    ch = log->createChannel("TextResourceRequestParser" );
...
void TextResourceRequestParser::parseFieldValue( string value, field_t *f)
{
    int n;
...
string TextResourceRequestParser::getMiscVal(miscList_t *_miscList, string name)
{
    miscListIter_t iter;
...
/* ------------------------- parseTime ------------------------- */
time_t TextResourceRequestParser::parseTime(string timestr)
{
    struct tm  t;
...
void TextResourceRequestParser::calculateInterval(time_t now, miscList_t *miscList, 
