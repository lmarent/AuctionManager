...
/*! \file   CtrlComm.h
    ...
    Description:
    agent manager control interface

    $Id: CtrlComm.h 748 2015-08-25 10:55:00Z amarentes $
*/
...
/*! 
 * 	the CtrlComm class is responsible for handling network connections to the agent manager.
...
class CtrlComm : public auction::AuctionManagerComponent
{
  ...
  public:
    ...
    */
    ...
    //! Process the message that arrives, it creates a new request
    char *processAddRequest(parseReq_t *preq );
