...
/*! \ file Logger.cc
	...
	$Id: Error.h 748 2015-07-23 09:28:23 amarentes $
...
Logger *Logger::getInstance(const string defaultFile)
{ 
    cout << "In getInstance defaultFile:" << defaultFile <<endl;
    
    if (s_instance == NULL) {
        s_instance = new Logger(defaultFile);
    }
    return s_instance;
}
