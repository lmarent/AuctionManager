...
/*! \file   SessionIdSource.h
    ...
    Description:
    manage unique numeric Session id space

    $Id: SessionIdSource.h 748 2015-10-01 18:56:00Z amarentes $
*/

#ifndef _SESSION_IDSOURCE_H_
#define _SESSION_IDSOURCE_H_
...
/*! \short   generate unique id numbers
    ...
    The SessionIdSource class can generate unique 32 bit integer numbers for
...
class SessionIdSource
{
  ...
  public:
    ...
    //! construct and initialize a SessionIdSource object
    ...
    SessionIdSource(int unique = 0);

    //! destroy a SessionIdSource object
    ~SessionIdSource();
...
//! overload for <<, so that a SessionIdSource object can be thrown into an iostream
ostream& operator<< ( ostream &os, SessionIdSource &ris );

}; // namespace auction

#endif // _SESSION_IDSOURCE_H_
