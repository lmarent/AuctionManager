...
/*! \file   AllocationIdSource.h
    ...
    $Id: AllocationIdSource.h 748 2015-08-20 14:52:00Z amarentes $
*/

#ifndef _ALLOCATIONIDSOURCE_H_
#define _ALLOCATIONIDSOURCE_H_
...
class AllocationIdSource
{
  ...
  public:
    ...
    //! construct and initialize a AllocationIdSource object
    ...
    AllocationIdSource(int unique = 0);

    //! destroy a AllocationIdSource object
    ~AllocationIdSource();
...
//! overload for <<, so that a AllocationIdSource object can be thrown into an iostream
ostream& operator<< ( ostream &os, AllocationIdSource &ris );

}; // namespace auction

#endif // _ALLOCATIONIDSOURCE_H_
