...
#define AUM_PROC_PARAMETER_ERROR -1
#define AUM_PROC_BANDWIDTH_AVAILABLE_ERROR -2
#define AUM_PRICE_RESERVE_ERROR -3
#define AUM_FIELD_NOT_FOUND_ERROR -4
#define AUM_DATETIME_NOT_DEFINED_ERROR -5
