...
/*! \file   AuctionIdSource.h
    ...
    $Id: AuctionIdSource.h 748 2015-08-04 14:47:00Z amarentes $
*/

#ifndef _AUCTION_IDSOURCE_H_
#define _AUCTION_IDSOURCE_H_
...
/*! \short   generate unique id numbers
    ...
    The AuctionIdSource class can generate unique 32 bit integer numbers for
...
class AuctionIdSource
{
  ...
  public:
    ...
    //! construct and initialize a AuctionIdSource object
    //! if unique is set to 1 Ids should be unique until we wrap around 2^16
						       
    AuctionIdSource(int unique = 0);

    //! destroy a AuctionIdSource object
    ~AuctionIdSource();
